...
INSERT INTO "new_Order" ("archived", "archivedAt", "code", "createdAt", "customerId", "date", "discount", "discountType", "id", "notes", "paymentStatus", "shipToAddress", "shipToCity", "shipToCountry", "shipToEmail", "shipToName", "shipToPhone", "shipToPostalCode", "shipToProvince", "shipmentStatus", "shippedAt", "shipping", "taxRate", "updatedAt") SELECT "archived", "archivedAt", "code", "createdAt", "customerId", "date", "discount", "discountType", "id", "notes", "paymentStatus", "shipToAddress", "shipToCity", "shipToCountry", "shipToEmail", "shipToName", "shipToPhone", "shipToPostalCode", "shipToProvince", "shipmentStatus", "shippedAt", "shipping", "taxRate", "updatedAt" FROM "Order";
DROP TABLE "Order";
