...
-- AlterTable
ALTER TABLE "Movement" ADD COLUMN "quality" TEXT;
...
CREATE TABLE "new_InventoryType" (
    ...
    "hasGender" BOOLEAN NOT NULL DEFAULT false,
    "hasPrice" BOOLEAN NOT NULL DEFAULT false,
    "hasQuality" BOOLEAN NOT NULL DEFAULT false,
    "defaultUnit" TEXT NOT NULL,
    "sortOrder" INTEGER NOT NULL DEFAULT 0
);
INSERT INTO "new_InventoryType" ("defaultUnit", "description", "hasBatches", "hasColor", "hasDescription", "hasExpiry", "hasMachineInfo", "hasSize", "id", "isProductionInput", "key", "label", "singular", "sortOrder") SELECT "defaultUnit", "description", "hasBatches", "hasColor", "hasDescription", "hasExpiry", "hasMachineInfo", "hasSize", "id", "isProductionInput", "key", "label", "singular", "sortOrder" FROM "InventoryType";
